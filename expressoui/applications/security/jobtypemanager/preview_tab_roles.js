expresso.applications.security.jobtypemanager.PreviewTabRoles = expresso.layout.resourcemanager.PreviewTab.extend({
    ...
    initDOMElement: function ($domElement) {
        ...
        this.addPromise(expresso.Common.sendRequest("role").done(function (roles) {
            ...
            $rolesDiv.find("input").on("click", function () {
                ...
                expresso.Common.sendRequest("jobtype/" + _this.resourceManager.currentResource.id +
    ...
    refresh: function (resource) {
        ...
        var allowed = expresso.Common.isUserAllowed("jobtype/role", "create");
        ...
        if (resource && resource.id) {
            ...
            expresso.Common.sendRequest("jobtype/" + resource.id + "/role").done(function (roles) {
